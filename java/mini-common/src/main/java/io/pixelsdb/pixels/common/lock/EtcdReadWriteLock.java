...
public class EtcdReadWriteLock
{
    ...
    public EtcdMutex readLock()
    {
        ...
        {
            this.readMutex = new InternalInterProcessMutex(client, basePath, READ_LOCK_NAME, lockData);
        }
    ...
    public EtcdMutex writeLock()
    {
        ...
        {
            this.writeMutex = new InternalInterProcessMutex(client, basePath, WRITE_LOCK_NAME, lockData);
        }
